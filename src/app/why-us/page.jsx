    ...
    <div className='gap-12 flex items-center justify-center py-24'>
      <div className='gap-6 flex flex-col items-center text-center mb-72'>
        ...
        <p className='text-primary-gray text-xl font-medium max-[480px]:text-base'>
          ...
          Backed by a supportive community, we provide guidance, inspiration and help every step of the way. Our focus is on delivering professional results,
          ensuring your website looks polished and effective. Experience the ease of website creation with Ubift Team today!
        </p>
